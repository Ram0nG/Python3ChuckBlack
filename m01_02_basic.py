...
print("name:", name, "account:", account_no, "balance:", "$"\ #This (\) is to continue with the code
+ str(balance))                                               #Instead of having a long line of code  
print("name:", name, "account:", account_no, "balance:", "$" \
+ str(float(balance)))
